#!/usr/bin/env python3
"""
Import Data to PostgreSQL Production Database
นำเข้าข้อมูลไปยัง PostgreSQL ใน production
"""
...
def check_database_connection():
    ...
    try:
        ...
        print("💡 ตรวจสอบ DATABASE_URL ใน .env")
        return False
...
def main():
    """ฟังก์ชันหลัก"""
    print("🚀 เริ่มต้นการนำเข้าข้อมูลไปยัง PostgreSQL Production...")
    ...
    try:
        ...
        print("\n🎉 การนำเข้าข้อมูลไปยัง PostgreSQL เสร็จสิ้น!")
